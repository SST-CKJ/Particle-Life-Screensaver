...
class Particle_LifeView: ScreenSaverView {
    ...
    private let numTypes = 6
    private let maxDistance: CGFloat = 80.0
    private let forceFactor: CGFloat = 5.0
    private let beta: CGFloat = 0.3
    private let frictionFactor: CGFloat = 0.95
    ...
    override func draw(_ rect: NSRect) {
        ...
        // Draw particles
        let particleRadius: CGFloat = 3.0
